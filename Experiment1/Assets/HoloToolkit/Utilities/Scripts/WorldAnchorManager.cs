...
namespace HoloToolkit.Unity
{
    ...
    public class WorldAnchorManager : Singleton<WorldAnchorManager>
    {
        ...
        {
            /// <summary> 
            /// Not entirely sure about this in start but oh well, that's why this runs before default time and 
            /// tap to place runs after and the official Holotoolkit implementation in Awake() doesn't work 
            /// for anybody on Unity 5.6. Should be good enough for this project given the deadlines.
            /// </summary>
            ...
            switch (anchorAttachmentInfo.Operation)
            {
                ...
                case AnchorOperation.Delete:
                    ...
                    if (anchor != null)
                    {
                        ...
                        Debug.Log("Removed world anchor !");
                    }
                    else
                    {
