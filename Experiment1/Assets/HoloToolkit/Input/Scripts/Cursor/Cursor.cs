...
using UnityEngine;
// MODIFIED for the states to ignore SpatialMapping
namespace HoloToolkit.Unity.InputModule
{
    ...
    public abstract class Cursor : MonoBehaviour, ICursor
    {
        ...
        public enum CursorStateEnum
        {
            ...
            /// <summary>
            /// Speaker cursor when the cursor is over a label
            /// </summary>
            Speaker
        }
        ...
        {
            if (MySceneManager.Instance.cursorIsSpeaker)
            {
                return CursorStateEnum.Speaker;
            }
